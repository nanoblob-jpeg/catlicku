...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		\begin{itemize}
			...
			\item \lstinline{#pragma GCC optimize ("unroll-loops")} reduces number of branches and optimizes parallel computation, but increased code size => instruction cache misses.
